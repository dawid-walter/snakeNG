...
module.exports = __webpack_require__(/*! C:\Dev\snakeNg\src\main.ts */"zUnb");
...
/* harmony import */ var _settings_global__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../settings/global */ "TL1N");
/* harmony import */ var _directions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./directions */ "yQGp");
...
class Snake {
    constructor(color) {
        this.color = color;
        this.snakeBody = [
            { x: 4 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + 5 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"], y: _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + (2 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"]) },
            { x: 3 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + 4 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"], y: _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + (2 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"]) },
            { x: 2 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + 3 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"], y: _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + (2 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"]) },
            { x: 1 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + 2 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"], y: _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + (2 * _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"]) }
        ];
    }
    getSnake() {
    ...
    moveSnakeTo(direction) {
        ...
        if (direction === _directions__WEBPACK_IMPORTED_MODULE_1__["DIRECTIONS"].RIGHT) {
            this.snakeBody.unshift({ x: this.getSnakeHead().x + _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"], y: this.getSnakeHead().y });
        }
        if (direction === _directions__WEBPACK_IMPORTED_MODULE_1__["DIRECTIONS"].DOWN) {
            this.snakeBody.unshift({ x: this.getSnakeHead().x, y: this.getSnakeHead().y + _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] + _settings_global__WEBPACK_IMPORTED_MODULE_0__["GRID_SIZE"] });
        }
    ...
    isHittingWall(width, height) {
        return this.getSnakeHead().x <= -_settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] || this.getSnakeHead().x >= width + _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] ||
            this.getSnakeHead().y <= -_settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"] || this.getSnakeHead().y >= height + _settings_global__WEBPACK_IMPORTED_MODULE_0__["BLOCK_SIZE"];
    }
    isEatingItself() {
...
/* harmony import */ var _snake_game_snake_game_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./snake-game/snake-game.component */ "gbrh");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_snake_game_snake_game_component__WEBPACK_IMPORTED_MODULE_1__["SnakeGameComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAuY29tcG9uZW50LmNzcyJ9 */"] });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "APPLE_COLOR", function() { return APPLE_COLOR; });
const BLOCK_SIZE = 30;
const COLS = 20;
const ROWS = 20;
const GRID_SIZE = 1;
...
/* harmony import */ var _snake_game_snake_game_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./snake-game/snake-game.component */ "gbrh");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_1__["AppComponent"],
        _snake_game_snake_game_component__WEBPACK_IMPORTED_MODULE_2__["SnakeGameComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]] }); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SnakeGameComponent", function() { return SnakeGameComponent; });
/* harmony import */ var _objects_snake__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objects/snake */ "JQqH");
/* harmony import */ var _settings_global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings/global */ "TL1N");
/* harmony import */ var _objects_directions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./objects/directions */ "yQGp");
/* harmony import */ var _objects_key_code__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./objects/key-code */ "H2YD");
...
const _c0 = ["snake"];
function SnakeGameComponent_ng_container_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementContainer"](0);
} }
function SnakeGameComponent_ng_template_17_Template(rf, ctx) { if (rf & 1) {
    const _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "div", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](1, "button", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function SnakeGameComponent_ng_template_17_Template_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r7); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return ctx_r6.pauseGame(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](2, " Pause Game ");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
} }
function SnakeGameComponent_ng_template_19_Template(rf, ctx) { if (rf & 1) {
    const _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "div", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](1, "button", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function SnakeGameComponent_ng_template_19_Template_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r9); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return ctx_r8.resumeGame(); });
...
class SnakeGameComponent {
    constructor() {
        this.speed = 1;
        this.time = { start: 0, elapsed: 0, total: 2000 };
    ...
    randomApple() {
        const random1 = Math.floor(Math.random() * _settings_global__WEBPACK_IMPORTED_MODULE_1__["COLS"] - 1) + 1;
        const random2 = Math.floor(Math.random() * _settings_global__WEBPACK_IMPORTED_MODULE_1__["ROWS"] - 1) + 1;
        this.apple = { x: random1 * _settings_global__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"] + random1 + _settings_global__WEBPACK_IMPORTED_MODULE_1__["GRID_SIZE"], y: random2 * _settings_global__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"] + random2 + _settings_global__WEBPACK_IMPORTED_MODULE_1__["GRID_SIZE"] };
    }
    drawSnake() {
        this.snake.getSnake().forEach(snakeBlock => {
            this.drawRoundedCornerRec(snakeBlock.x, snakeBlock.y, _settings_global__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"], _settings_global__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"], 20, this.snake.color);
        });
    }
    drawRoundedCornerRec(x, y, width, height, radius, color) {
...
SnakeGameComponent.ɵfac = function SnakeGameComponent_Factory(t) { return new (t || SnakeGameComponent)(); };
SnakeGameComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: SnakeGameComponent, selectors: [["app-snake-game"]], viewQuery: function SnakeGameComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, hostBindings: function SnakeGameComponent_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("keydown", function SnakeGameComponent_keydown_HostBindingHandler($event) { return ctx.keyEvent($event); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵresolveWindow"]);
    } }, decls: 24, vars: 6, consts: [[1, "grid"], [1, "game-board"], ["snake", ""], [1, "right-column"], [1, "button-container"], [1, "play-button", "button", 3, "click"], [4, "ngIf", "ngIfThen", "ngIfElse"], ["pause", ""], ["resume", ""], [1, "pause-button", "button", 3, "click"]], template: function SnakeGameComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function SnakeGameComponent_Template_button_click_14_listener() { return ctx.playGame(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function SnakeGameComponent_Template_button_click_22_listener() { return ctx.resetGame(); });
